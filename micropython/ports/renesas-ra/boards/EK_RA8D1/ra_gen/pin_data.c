...
{ .pin = BSP_IO_PORT_01_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_01_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_03_PIN_05, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_06, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_10, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_11, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_03_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_05_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_SDHI_MMC) },

{ .pin = BSP_IO_PORT_05_PIN_05, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_05_PIN_06, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_05_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_05_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_05_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_06_PIN_00, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_OSPI) },
...
{ .pin = BSP_IO_PORT_06_PIN_06, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_06_PIN_11, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_06_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_06_PIN_15, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_08_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_OSPI) },

{ .pin = BSP_IO_PORT_08_PIN_04, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_OSPI) },

{ .pin = BSP_IO_PORT_08_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_OSPI) },

{ .pin = BSP_IO_PORT_08_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_OSPI) },
...
{ .pin = BSP_IO_PORT_08_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_SDHI_MMC) },

{ .pin = BSP_IO_PORT_08_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_09_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_09_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },
...
{ .pin = BSP_IO_PORT_10_PIN_05, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_06, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_08, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_10, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_11, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_12, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_13, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_10_PIN_15, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_BUS) },

{ .pin = BSP_IO_PORT_11_PIN_01, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
