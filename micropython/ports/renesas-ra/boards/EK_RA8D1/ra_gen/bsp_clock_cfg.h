...
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(160,0) /* PLL Mul x160-180|Mul x160|PLL Mul x160.00 */
...
#define BSP_CFG_PLL1R_FREQUENCY_HZ (240000000) /* PLL1R 240000000Hz */
...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(100,0) /* PLL2 Mul x100-119|Mul x100|PLL2 Mul x100.00 */
#define BSP_CFG_PLL2_FREQUENCY_HZ (800000000) /* PLL2 800000000Hz */
#define BSP_CFG_PL2ODIVP (BSP_CLOCKS_PLL_DIV_4) /* PLL2P Div /4 */
#define BSP_CFG_PLL2P_FREQUENCY_HZ (200000000) /* PLL2P 200000000Hz */
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_6) /* PLL2Q Div /6 */
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (133333333) /* PLL2Q 133333333Hz */
#define BSP_CFG_PL2ODIVR (BSP_CLOCKS_PLL_DIV_4) /* PLL2R Div /4 */
#define BSP_CFG_PLL2R_FREQUENCY_HZ (200000000) /* PLL2R 200000000Hz */
...
#define BSP_CFG_UCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* USBCLK Src: PLL1R */
#define BSP_CFG_USB60CLK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* USB60CLK Disabled */
#define BSP_CFG_OCTACLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2P) /* OCTACLK Src: PLL2P */
...
#define BSP_CFG_SCICLK_DIV (BSP_CLOCKS_SCI_CLOCK_DIV_8) /* SCICLK Div /8 */
